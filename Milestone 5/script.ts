...
const shareableLinkContainer: HTMLDivElement = document.getElementById('shareable-linkcontainer') as HTMLDivElement; 
const shareableLinkElement: HTMLAnchorElement = document.getElementById('shareable-link') as HTMLAnchorElement; 
